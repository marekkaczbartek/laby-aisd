...
public class GraphTests {
    @Test
    public void depthFirst_subgraph0() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("zero, two, one, four, three, five", graph.depthFirst("zero"));
    }

    @Test
    public void depthFirst_subgraph1() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("one", graph.depthFirst("one"));
    }

    @Test
    public void depthFirst_subgraph2() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("two, one", graph.depthFirst("two"));
    }

    @Test
    public void depthFirst_subgraph3() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("three, one, five, zero, two, four", graph.depthFirst("three"));
    }

    @Test
    public void depthFirst_subgraph4() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("four, two, one, three, five, zero", graph.depthFirst("four"));
    }

    @Test
    public void depthFirst_subgraph5() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("five, zero, two, one, four, three", graph.depthFirst("five"));
    }

    @Test
    public void depthFirst_subgraph6() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("six, seven, eight", graph.depthFirst("six"));
    }

    @Test
    public void depthFirst_subgraph7() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("seven, eight, six", graph.depthFirst("seven"));
    }

    @Test
    public void depthFirst_subgraph8() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("eight, six, seven", graph.depthFirst("eight"));
    }

    @Test
    public void depthFirst_subgraph9() throws FullStackException {
        var graph = createTestGraph();
        assertEquals("nine, ten", graph.depthFirst("nine"));
    }

    @Test
    public void depthFirst_subgraph10() throws FullStackException {
        var graph = createTestGraph();
